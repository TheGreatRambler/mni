...
*/
    ...
    /**
     * This method handles adding the SDL surface to a layout and returning it
     * It can be overridden by derived classes.
     */
    protected ViewGroup addApplicationSurface(SurfaceView surface) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayout = addApplicationSurface(mSurface);
